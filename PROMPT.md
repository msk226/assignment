...
### 사용한 AI 도구
- **백엔드**: Claude (서브 에이전트 활용), Github Copilot
...
**프롬프트:**
> 앱 아이콘이랑 스플래시 화면에 @frontend/src/assets/logo.png 로고 반영해줘
